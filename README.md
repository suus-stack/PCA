...
* Density_herring_school_plot: Boxplot with strip plot overlap that shows the distribution
                  of the herring count within the original separation distance (6) across.
                  various conditions.
                  - ####HOW TO RUN###
